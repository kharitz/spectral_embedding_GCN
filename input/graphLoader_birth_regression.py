...
def make_dataset(root, mode, hemi):
    ...
    items = []
    if mode == 'train':
        train_data = np.load('./dataset/birth_scan_age/train.npy', allow_pickle=True)
        ...
        val_data = np.load('./dataset/birth_scan_age/validation.npy', allow_pickle=True)
        ...
        test_data = np.load('./dataset/birth_scan_age/test.npy', allow_pickle=True)
