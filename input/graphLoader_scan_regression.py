...
def make_dataset(root, mode, hemi):
    ...
    items = []
    if mode == 'train':
        train_data = np.load('./dataset/scan_regression/train.npy', allow_pickle=True)
        ...
        val_data = np.load('./dataset/scan_regression/validation.npy', allow_pickle=True)
        ...
        test_data = np.load('./dataset/scan_regression/test.npy', allow_pickle=True)
